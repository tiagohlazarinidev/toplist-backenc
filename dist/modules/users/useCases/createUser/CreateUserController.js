...
var CreateUserController = /** @class */ (function () {
    ...
    CreateUserController.prototype.handle = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, cpf, name, email, streetname, housenumber, borough, cityname, cep, createUserUseCase, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, cpf = _a.cpf, name = _a.name, email = _a.email, streetname = _a.streetname, housenumber = _a.housenumber, borough = _a.borough, cityname = _a.cityname, cep = _a.cep;
