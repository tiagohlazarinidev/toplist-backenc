...
var CreateUserUseCase = /** @class */ (function () {
    ...
    CreateUserUseCase.prototype.execute = function (_a) {
        var cpf = _a.cpf, name = _a.name, email = _a.email, streetname = _a.streetname, housenumber = _a.housenumber, borough = _a.borough, cityname = _a.cityname, cep = _a.cep;
        return __awaiter(this, void 0, void 0, function () {
            var userAlreadyExists, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, client_1.prisma.client.findUnique({
                            where: {
                                email: email
                            }
                        })];
